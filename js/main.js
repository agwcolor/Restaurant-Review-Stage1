...
fetchNeighborhoods = () => {
    DBHelper.fetchNeighborhoods((error, neighborhoods) => {
        ...
        const leaflet_attrib = document.querySelector(".leaflet-control-attribution");
        leaflet_attrib.setAttribute("tabindex", "-1");
    });
}
...
initMap = () => {
    ...
    L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
        mapboxToken: 'pk.eyJ1IjoiYWJiaWV3IiwiYSI6ImNqbW12eDc2MjBuZzkzcW83YzczM3RhaDMifQ.eMmDm29jiMFiJsJTz6LsNQ',
        maxZoom: 18,
        attribution: 'Map data &copy; <a aria-label="Leaflet Attribution" href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, ' +
